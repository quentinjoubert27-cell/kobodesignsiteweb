// api/track.js — Enregistre une page vue avec fingerprint visiteur
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // Fingerprint anonyme : hash de ip + ua + country + language + screen + timezone
    // Aucune de ces données n'est stockée individuellement — seul le hash l'est
